...
import (
	...
	"github.com/andock/ssh2docksal/pkg/sysloghandler"
	"github.com/apex/log"
...
func main() {
	...
	app.Email = "https://github.com/andock/ssh2docksal"
	app.Version = VERSION
	...
	app.Flags = []cli.Flag{
		...
		cli.BoolFlag{
			...
			Usage: "Cleanup Docker containers created by ssh2docksal on start",
		},
		cli.StringFlag{
...
func Action(c *cli.Context) {
	...
	server, err := ssh2docksal.NewServer()
	if err != nil {
